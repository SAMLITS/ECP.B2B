        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    //ÊÇ·ñ°üº¬html±êÇ©
                    var reg = /<[^>]+>/g;
                    var checkIsHtml = reg.test(value);
                    ...
                    text = that.options.cardView ? ['<div class="card-view">',
                        ...
                        '</div>'
                    ].join('') : [sprintf('<td%s %s %s %s %s %s>', id_, class_, style, data_, rowspan_, title_),  //title_ -> value
                    "<span " + sprintf(' data-toggle="tooltip"  data-placement="bottom"  title="%s"', checkIsHtml ? "" : value) + ">" + value + "</span>",
                        '</td>'
                    ].join('');
