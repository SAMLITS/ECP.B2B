...
namespace ECP.Util.Common.Cache
{
    public class MemoryCacheService : ICacheService
    {
        ...
        {
            return Task.Run(() => Add(key, value, expiresSliding, expiressAbsoulte));
        }
        ...
        {
            return Task.Run(() => Add(key, value, expiresIn, isSliding));
        }
        #endregion
        ...
        {
            return Task.Run(() => Replace(key, value, expiresSliding, expiressAbsoulte));
        }
        ...
        {
            return Task.Run(() => Replace(key, value, expiresIn, isSliding));
        }
        #endregion 
    }
}
