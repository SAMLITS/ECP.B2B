...
{ 
	...
	{ 		
        ...
        //获取Hash描述表 
        public string GetHash_uft8(string m_strSource)
        {
            ...
            //HashData = MD5.ComputeHash(Buffer);
             ...
             ;
             byte[] data = System.Security.Cryptography.MD5CryptoServiceProvider.Create().ComputeHash(Encoding.UTF8.GetBytes(m_strSource));
            ...
            //string strHashData = Convert.ToBase64String(HashData);
            //return strHashData;
