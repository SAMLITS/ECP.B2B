...
using ECP.B2b.AttributeModel.Mvc;
...
namespace ECP.Util.HtmlHelper.Filter
{
    ...
    public class LoginManagerAuthorityFilterAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
                    ...
                    if (!string.IsNullOrEmpty(funCode))
                    {
                        ...
                        if (!funcList.Contains(funCode))
                        {
                            ...
                            if (context.HttpContext.Request.Headers["X-Requested-With"] == "XMLHttpRequest")
                                ...
                                context.Result = new RedirectToRouteResult(new RouteValueDictionary(new { area = "", controller = "Admin", action = "NotAuthority" }));
                        }
                    }
                }
            ...
            if (context.HttpContext.Request.Headers["X-Requested-With"] == "XMLHttpRequest")
                ...
                context.Result = new RedirectToRouteResult(new RouteValueDictionary(new { area="", controller = "Admin", action = "Login" }));
        }
    }
}